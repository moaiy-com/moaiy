...
enum GPGError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .gpgNotFound:
            return AppLocalization.string("error_gpg_not_found")
        case .executionFailed(let message):
            return "\(AppLocalization.string("error_execution_failed")): \(message)"
        case .invalidOutput(let message):
            return "\(AppLocalization.string("error_invalid_output")): \(message)"
        case .keyNotFound(let identifier):
            return "\(AppLocalization.string("error_key_not_found")): \(identifier)"
        case .keyGenerationFailed(let message):
            return "\(AppLocalization.string("error_key_generation_failed")): \(message)"
        case .encryptionFailed(let message):
            return "\(AppLocalization.string("error_encryption_failed")): \(message)"
        case .decryptionFailed(let message):
            return "\(AppLocalization.string("error_decryption_failed")): \(message)"
        case .importFailed(let message):
            return "\(AppLocalization.string("error_import_failed")): \(message)"
        case .exportFailed(let message):
            return "\(AppLocalization.string("error_export_failed")): \(message)"
        case .invalidPassphrase:
            return AppLocalization.string("error_invalid_passphrase")
        case .operationCancelled:
            return AppLocalization.string("error_operation_cancelled")
        case .fileAccessDenied(let path):
            return "\(AppLocalization.string("error_file_access_denied")): \(path)"
        case .unsupportedKeyType(let type):
            return "\(AppLocalization.string("error_unsupported_key_type")): \(type)"
        case .trustUpdateFailed(let message):
            return "\(AppLocalization.string("error_trust_update_failed")): \(message)"
        case .keySigningFailed(let message):
            return "\(AppLocalization.string("error_key_signing_failed")): \(message)"
        case .keyserverUploadFailed(let message):
            return "\(AppLocalization.string("error_keyserver_upload_failed")): \(message)"
        case .smartCardNotPresent:
            return AppLocalization.string("error_smartcard_not_present")
        case .smartCardUnavailable:
            return AppLocalization.string("error_smartcard_unavailable")
        case .smartCardPinInvalid:
            return AppLocalization.string("error_smartcard_pin_invalid")
        }
    }
    ...
    var recoverySuggestion: String? {
        switch self {
        case .gpgNotFound:
            return AppLocalization.string("error_gpg_not_found_recovery")
        case .executionFailed:
            return AppLocalization.string("error_execution_failed_recovery")
        case .invalidOutput:
            return AppLocalization.string("error_invalid_output_recovery")
        case .keyNotFound:
            return AppLocalization.string("error_key_not_found_recovery")
        case .keyGenerationFailed:
            return AppLocalization.string("error_key_generation_failed_recovery")
        case .encryptionFailed:
            return AppLocalization.string("error_encryption_failed_recovery")
        case .decryptionFailed:
            return AppLocalization.string("error_decryption_failed_recovery")
        case .importFailed:
            return AppLocalization.string("error_import_failed_recovery")
        case .exportFailed:
            return AppLocalization.string("error_export_failed_recovery")
        case .invalidPassphrase:
            return AppLocalization.string("error_invalid_passphrase_recovery")
        case .operationCancelled:
            return AppLocalization.string("error_operation_cancelled_recovery")
        case .fileAccessDenied:
            return AppLocalization.string("error_file_access_denied_recovery")
        case .unsupportedKeyType:
            return AppLocalization.string("error_unsupported_key_type_recovery")
        case .trustUpdateFailed:
            return AppLocalization.string("error_trust_update_failed_recovery")
        case .keySigningFailed:
            return AppLocalization.string("error_key_signing_failed_recovery")
        case .keyserverUploadFailed:
            return AppLocalization.string("error_keyserver_upload_failed_recovery")
        case .smartCardNotPresent:
            return AppLocalization.string("error_smartcard_not_present_recovery")
        case .smartCardUnavailable:
            return AppLocalization.string("error_smartcard_unavailable_recovery")
        case .smartCardPinInvalid:
            return AppLocalization.string("error_smartcard_pin_invalid_recovery")
        }
    }
}
...
enum UserFacingErrorMapper {
    ...
    static func decryptionKeyMismatchMessage(
        ...
        let baseMessage = AppLocalization.string("error_decryption_requires_private_key")
        ...
        return "\(baseMessage)\n\(AppLocalization.string("label_key_id")): \(keyHint)"
    }
    ...
    private static func message(for error: GPGError, context: UserFacingErrorContext) -> String {
        ...
        case .operationCancelled:
            return AppLocalization.string("error_operation_cancelled")
        case .encryptionFailed:
            return AppLocalization.string("error_encryption_failed")
        case .decryptionFailed:
            return AppLocalization.string("error_decryption_failed")
        case .importFailed:
            return AppLocalization.string("error_import_failed")
        case .exportFailed:
            return AppLocalization.string("error_export_failed")
        case .keyNotFound:
            if context == .decrypt {
                return AppLocalization.string("error_decryption_requires_private_key")
            }
            return AppLocalization.string("error_key_not_found")
        case .keyGenerationFailed:
            return AppLocalization.string("error_key_generation_failed")
        case .fileAccessDenied:
            return AppLocalization.string("error_file_access_denied")
        case .unsupportedKeyType:
            return AppLocalization.string("error_unsupported_key_type")
        case .trustUpdateFailed:
            return AppLocalization.string("error_trust_update_failed")
        case .keySigningFailed:
            return AppLocalization.string("error_key_signing_failed")
        case .keyserverUploadFailed(let message):
    ...
    private static func mapRawMessage(_ rawMessage: String, context: UserFacingErrorContext) -> String {
        ...
        if context == .keyserverUpload {
            if lowercasedMessage.contains("no dirmngr")
                ...
                return AppLocalization.string("error_keyserver_upload_unavailable")
            }
            if lowercasedMessage.contains("timed out")
                ...
                return AppLocalization.string("error_keyserver_upload_network")
            }
        }
        if context == .verify {
    ...
    private static func friendlyVerifyMessage(from lowercasedMessage: String) -> String {
        ...
        return AppLocalization.string("verify_signature_error_generic")
    }

    private static func defaultMessage(for context: UserFacingErrorContext) -> String {
        switch context {
        case .general:
            return AppLocalization.string("error_operation_failed_generic")
        case .keyList:
            return AppLocalization.string("key_list_error_load_failed")
        case .encrypt:
            return AppLocalization.string("error_encryption_failed")
        case .decrypt:
            return AppLocalization.string("error_decryption_failed")
        ...
        case .verify:
            return AppLocalization.string("verify_signature_error_generic")
        case .backup:
            return AppLocalization.string("backup_error_operation_failed")
        case .importKey:
            return AppLocalization.string("error_import_failed")
        case .exportKey:
            return AppLocalization.string("error_export_failed")
        case .trust:
            return AppLocalization.string("error_trust_update_failed")
        case .keyEdit:
            return AppLocalization.string("edit_error_operation_failed")
        case .keyserverUpload:
            return AppLocalization.string("error_keyserver_upload_failed")
        }
    }

    private static func isFriendlyMessage(_ message: String) -> Bool {
        let friendlyMessages = [
            AppLocalization.string("verify_signature_error_no_signature"),
            AppLocalization.string("verify_signature_error_bad_signature"),
            AppLocalization.string("verify_signature_error_missing_public_key"),
            AppLocalization.string("verify_signature_error_missing_original"),
            AppLocalization.string("verify_signature_error_generic"),
            AppLocalization.string("verify_signature_failed"),
            AppLocalization.string("error_operation_failed_generic"),
            AppLocalization.string("key_list_error_load_failed"),
            AppLocalization.string("backup_error_operation_failed"),
            AppLocalization.string("edit_error_operation_failed")
        ]
